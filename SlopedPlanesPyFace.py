                                        ...
                                        if fAng == sAng:
                                            ...
                                            eGeom =\
                                                Part.LineSegment(fGeom,
                                                                 startParam,
                                                                 endParam)
                                            pyPlane.geomAligned = eGeom.toShape()
                                    ...
                                    if not pyEnd.rear:
                                        ...
                                        if corner == 'reflex':
                                            ...
                                            if not pyPl.forward:
                                                self.forBack(pyPl,
                                                             'forward')
                                                self.forBack(pyNextPlane,
                                                             'backward')
                                            self.findRear(pyWire, pyPl,
                                                          'forward')
                                            self.findRear(pyWire, pyNextPlane,
                                                          'backward')
                                            self.doReflex(pyWire, pyPl,
                                                          pyNextPlane)
                                    ref = False
                            ...
                            if corner == 'reflex':
                                ...
                                if not pyPlane.choped:
                                    ...
                                    if not pyNextPlane.choped:
                                        # print '2111 next is not an alignament'
                                        self.findRear(pyWire, pyPlane,
                                                      'forward')
