                            ...
                            if pyPlane.choped:
                                ...
                                for pyA in aList:
                                    ...
                                    if not section.Vertexes:
                                        # TODO cambiar este common, ver ordinaries y end
                ...
                if number != num:
                    ...
                    if section.Edges:
                        ...
                        if not section.Vertexes:
                            ...
                            print 'area 1', (pyAlign.base.numGeom, common.Area)
                            print 'area 2', (pyAl.base.numGeom, com.Area)
                            if not common.Area and not com.Area:
